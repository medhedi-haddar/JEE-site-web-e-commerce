 ...
 * @author hedi
 */
@WebServlet(name = "GestionArticle", urlPatterns = {"/GestionArticle"})
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet recherche_servlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet recherche_servlet at " + request.getContextPath() + "</h1>");
        ...
        try {
            ...
            while (parametres.hasMoreElements()) {
                ...
                if (param.equals("supprimer")) 
                {
                    ...
                    session.setAttribute("reference", ref);
                    session.setAttribute("page", "modifier");
                    response.sendRedirect("administrateur.jsp");                    
                }
            }
